                                    ...
                                    <table class="table table-bordered text-center">
                                        ...
                                        while ($row = mysqli_fetch_assoc($res)){?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="about_edit.php?about=<?php echo $row['id'];?>" class="btn btn-primary text-white">Edit</a> |
                                                    <a href="delete.php?about=<?php echo $row['id'];?>" class="btn btn-danger text-white">Delete</a>
                                                </td>
                                            </tr>
                                        <?php }
                                        ?>
